...
class ResetSuccess extends React.Component {
    ...
    return (
        <div id="reset-success-card">
        <GridContainer justify="space-evenly">
        <GridItem xs={12} sm={8} md={4}>
        <Card className={classes[this.state.cardAnimaton]} >
          <CardBody>
          <h3 id="home-card-text">Your password has been reset successfully. Proceed to <Link to='/login' id="login-link">Login</Link> page</h3>
          </CardBody>
        </Card>
        </GridItem>
            </GridContainer>
...
export default withStyles(style)(ResetSuccess);